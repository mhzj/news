...
<body>
	...
	if("".equals(find) || null==find){}
	 ...
	 <%} %>
		...
		<form action="findpwd" method="post" id="loginForm">
			<div>
			...
			<button id="submit" type="submit" value="找回密码">
				找回密码<!-- <a href="modifyPwd.jsp" style="text-decoration: none;color: black;">找回密码</a> -->
			</button>  
		</form>
