        ...
        <div class="col-md-12">
            <table class="table table-hover">
                ...
                <c:forEach items="${pageInfo.list }" var="news">
                    <tr>
                        &lt;%&ndash;<td>${news.nid}</td>
                        <td>${news.author}</td>&ndash;%&gt;
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <nav aria-label="Page navigation">
                <ul class="pagination">
                    <li><a href="${path}/searchByTitle1?pn=1&title=<%=title%>">首页</a>
                    </li>
                    <c:if test="${pageInfo.hasPreviousPage }">
                        <li><a
                                href="${path}/searchByTitle1?pn=${pageInfo.pageNum-1}&title=<%=title%>"
                    ...
                    <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                        ...
                        <c:if test="${page_Num != pageInfo.pageNum }">
                            <li><a href="${path}/searchByTitle1?pn=${ page_Num}&title=<%=title%>">${
                                    page_Num}</a>
                            </li>
                        </c:if>
                    </c:forEach>
                    ...
                    <li><a
                            href="${path}/searchByTitle1?pn=${pageInfo.pages}&title='<%=title%>'">末页</a>
                    </li>
                </ul>
            </nav>
        </div>
