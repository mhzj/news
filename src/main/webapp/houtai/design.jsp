    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.jsp">首页</a><span
                    class="crumb-step">&gt;</span><span class="crumb-name">新闻管理</span></div>
        </div>
                ...
                <form action="<%=request.getContextPath()%>/searchNews" method="post">
                    <table class="search-tab">
                        <tr>
                            ...
                            <th width="70">关键字:</th>
                            <td><input class="common-text" placeholder="关键字" name="title" value="" id="" type="text">
                            </td>
            ...
            <form name="myform" id="myform" method="post" action="<%=request.getContextPath()%>/moredel">
                <div class="result-title">
                    <div class="result-list">
                        ...
                        <%--<a href="../searchtupian" target="_blank"><i class="icon-font">&#xe048;</i>图片新闻</a>--%>
                        <%--<a href="../searchshipin" target="_blank"><i class="icon-font">&#xe048;</i>视频新闻</a>--%>
                        <%--<a href="../searchtongyong" target="_blank"><i class="icon-font">&#xe048;</i>通用新闻</a>--%>
                    </div>
                </div>
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <c:forEach items="${sessionScope.newslist }" var="i" varStatus="suoyin1">
                            <tr>
                                ...
                                <td title="${i.title }"><a target="_blank"
                                                           href="<%=request.getContextPath()%>/xinwenchushihua?flag=${i.nid }"
                                ...
                                <td>${i.sourcetype}</td>
                                <td><input name="hot" type="checkbox" disabled id="hot"
                                           <c:if test="${i.hot==0}">checked</c:if>/></td>
                                <td>${i.author}</td>
                                <td><fmt:formatDate value="${i.ntime }" pattern="yyyy-MM-dd"/>

                                </td>
                                <td><span id="sprycheckbox1">
                              <input name="ping" type="checkbox" disabled id="ping"
                                     <c:if test="${i.isreview==1}">checked</c:if>></span></td>
                                <td>
